...
class SpeedE extends Check implements Cancellable {

    private $lastNotCollided;
    private $lastTicks;

    public function __construct() {
        parent::__construct("Speed", "Collisions", CheckType::MOVEMENT);
    }
    ...
    public function onPacket(PacketReceiveEvent $e, User $user) {
        ...
        if(!$collided) {
            ...
            if($ticks > 3 && $ticks == $lastTicks && !$user->getPlayer()->isSpectator()) {
